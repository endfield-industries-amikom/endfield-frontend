      ...
      <div className="h-[7vh] px-2 flex items-center">
        <div className="container mx-auto flex items-center justify-between w-full">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            <NavLink
              to="/"
              className="hover:text-[#e0d31a] hover:font-bold transition"
            >
              Home
            </NavLink>
            <NavLink
          ...
          >
            <span
              className={`w-6 h-0.5 bg-[#202020] transition-all ${isOpen ? "rotate-45 translate-y-2" : ""}`}
            ></span>
            <span
              className={`w-6 h-0.5 bg-[#202020] transition-all ${isOpen ? "opacity-0" : ""}`}
            ></span>
            <span
              className={`w-6 h-0.5 bg-[#202020] transition-all ${isOpen ? "-rotate-45 -translate-y-2" : ""}`}
            ></span>
        ...
        <div className="md:hidden bg-[#FAFAFA] border-t border-gray-200">
          <nav className="flex flex-col gap-4 px-2 py-4 text-sm">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-full h-10 bg-white text-[#202020] placeholder:text-[#808080] border border-[#CCCCCC] focus:outline-none focus:ring-2 focus:ring-[#F8F546] px-2 rounded"
            />
          </nav>
        </div>
      )}
