export default function About() {
  return (
    <div className="bg-[#FAFAFA] min-h-screen overflow-hidden">
      <div
        className="relative text-white text-center py-[2vh] bg-cover bg-center"
        style={{
          backgroundImage:
      ...
      >
        ...
        <h1 className="relative text-[5vw] md:text-[3vw] lg:text-[1.8vw] font-semibold tracking-wide">
          About Endfield Industries
        </h1>
      </div>

      <div className="max-w-[90vw] mx-auto py-[8vh] px-[3vw]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[5vw]">
          <div>
            <h2 className="text-[5vw] md:text-[2.5vw] lg:text-[1.2vw] font-bold mb-[2vh] text-black">
              Our Profile Company
            </h2>

            <p className="text-[3.5vw] md:text-[1.8vw] lg:text-[0.9vw] text-black leading-relaxed">
              Endfield Industries is a massive, independent industrial
              corporation that serves as a cornerstone of humanity’s efforts to
              colonize the planet Talos-II.
            </p>
          </div>

          <div>
            <h2 className="text-[5vw] md:text-[2.5vw] lg:text-[1.2vw] font-bold mb-[2vh]">
              Our Vision and Mission
            </h2>

            <p className="text-[3.5vw] md:text-[1.8vw] lg:text-[0.9vw] text-black mb-[2vh] leading-relaxed">
              To be a pioneer of a new civilization capable of conquering and
              stabilizing the extreme environment.
            </p>

            <div className="text-[3.5vw] md:text-[1.8vw] lg:text-[0.9vw] text-black">
      ...
      <div className="bg-[#313739] py-[10vh]">
        <div className="max-w-[90vw] mx-auto text-center px-[3vw]">
          <div className="w-[25vw] md:w-[15vw] lg:w-[10vw] h-[0.6vh] bg-[#F8F546] mx-auto mb-[2vh] rounded-full"></div>

          <h2 className="text-[6vw] md:text-[3vw] lg:text-[2.1vw] font-bold mb-[1vh] text-white">
            Company Updates
          </h2>

          <p className="mt-[2vh] text-white text-[3vw] md:text-[1.6vw] lg:text-[0.9vw] mb-[5vh]">
          ...
          <div className="flex justify-center gap-[3vw] flex-wrap">
            <div className="bg-white p-[2vw] w-full md:w-[70vw] lg:w-[25vw] flex items-center gap-[1vw] rounded-xl shadow-xl transition duration-300 hover:translate-y-[-1vh] hover:shadow-2xl">
              ...
              <div className="text-left">
                <h4 className="font-semibold text-[3.5vw] md:text-[2vw] lg:text-[1vw]">
                  New Facility Expansion
                </h4>

                <p className="text-gray-500 text-[3vw] md:text-[1.5vw] lg:text-[0.9vw]">
